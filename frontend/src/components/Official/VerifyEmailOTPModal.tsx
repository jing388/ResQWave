      ...
      >
        ...
        <div className="mb-2 flex justify-center">
          ...
          >
            ...
            <InputOTPSeparator>
              <span className="mx-2 md:mx-3 text-white text-lg md:text-xl">
                &bull;
              </span>
            </InputOTPSeparator>
            <InputOTPGroup>
        ...
        <div className="mb-5 text-start">
          ...
          {resendMsg && (
            <div className="text-xs text-green-400 mt-1">{resendMsg}</div>
          )}
          {resendError && (
            <div className="text-xs text-red-500 mt-1">{resendError}</div>
          )}
        </div>
