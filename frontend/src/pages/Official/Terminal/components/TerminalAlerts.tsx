...
export default forwardRef<TerminalAlertsHandle>(
  function TerminalAlerts(_props, ref) {
    ...
    useImperativeHandle(
      ...
      () => ({
        ...
        showArchiveSuccess: (terminalName: string) => {
          hideAllAlerts();
          setArchiveMessage(
            `Terminal "${terminalName}" archived successfully!`,
          );
          setShowArchive(true);
        ...
        showRestoreSuccess: (terminalName: string) => {
          hideAllAlerts();
          setRestoreMessage(
            `Terminal "${terminalName}" restored successfully!`,
          );
          setShowRestore(true);
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[14px] text-[#a1a1a1] mb-1">
                    Are you sure you want to permanently delete terminal{" "}
