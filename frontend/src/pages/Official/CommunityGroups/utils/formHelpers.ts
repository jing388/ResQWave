...
export const convertFormToInfoData = (
  ...
  if (
    formData.focalPersonCoordinates &&
    formData.focalPersonCoordinates.includes(",")
  ) {
  ...
  return {
    ...
    alternativeFocalPerson: {
      altName:
        `${formData.altFocalPersonFirstName || ""} ${formData.altFocalPersonLastName || ""}`.trim() ||
        formData.altFocalPersonName,
      altPhoto: formData.altFocalPersonPhoto
        ? URL.createObjectURL(formData.altFocalPersonPhoto)
        : undefined,
